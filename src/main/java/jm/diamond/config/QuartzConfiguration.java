...
public class QuartzConfiguration {
  ...
  public SchedulerFactoryBean schedulerFactoryBean(
          DataSource datasource, JobFactory jobFactory, Trigger[] registryTrigger) throws Exception {
  ...
  /**
   * Spring Framework 의 Shutdown Hook 설정. Quartz 의 Shutdown 동작을 위임받아 Graceful Shutdown 을 보장. Quartz
   * 의 자체 Shutdown Plugin 을 사용하면 Spring 의 Datasource 가 먼저 Close 되므로, Spring 에게 Shutdown 동작을 위임하여,
   * 상위에서 컨트롤.
   *
